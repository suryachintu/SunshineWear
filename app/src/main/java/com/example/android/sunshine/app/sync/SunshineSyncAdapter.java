...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                if (i == 0)
                    temp = Math.round(high) + "," + Math.round(low) + "," + weatherId;
    ...
    private void sendData(String temp) {
        PutDataMapRequest putDataMapRequest = PutDataMapRequest.create("/sunshine_temp");

        putDataMapRequest.getDataMap().putString("temp",temp);
    ...
    public void onConnectionSuspended(int i) {
        Log.e(LOG_TAG,"Api Connection suspended");
    }

    @Override
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.e(LOG_TAG,"Api Connection failed");
    }
